        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-color:rgb(209, 62, 182);
...
<body>
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo">Dre<span>ams</span>T<span>ech</span></h1>
            <ul>
        ...
        <div class="content">
            <div class="text">
                <h2>Innovation Of Virtual Reality</h2>
                <br>
    ...
    <footer>
        <center> Designed and Developed by Naveen kumar V (212223230140) </center>
    </footer>
</body>
</html>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-color:rgb(216, 80, 200);
                background-size: cover;
                background-position: center;
            }
            .navbar {
...
<body>
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo">Dre<span>am</span>T<span>ech</span></h1>
            <ul>
                <li><a href="homes.html"> Home </a></li>
                <li><a href="Product.html"> Products </a></li>
                <li><a href="person.html"> People </a></li>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-color:rgb(185, 79, 176);
                background-size: cover;
                background-position: center;
            }
            .navbar {
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-color:rgb(195, 84, 191);
                background-size: cover;
                background-position: center;
            }
            .navbar {
...
<body>
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                <h2> CONTACT INFO </h2>
                <p> <span>Address</span> : No.41 PERUMAL KOVIL STREET, KAVERIPAKKAM </p>
                <p> <span>Email</span> : DreamTech@gmail.com.com </p>
                <p> <span>Phone</span> : 9842801062 </p>
            </div>
        </div>
    </div>
    <footer>
